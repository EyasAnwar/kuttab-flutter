...
import 'package:quran/screen/parent/parent_profile_screen.dart';
import 'package:quran/screen/parent/student_profile_screen.dart';
...
class _ParentHomeScreenState extends State<ParentHomeScreen> {
  ...
  void initState() {
    ...
    _teacherGetxController.getParentChildren(DateFormat('yyyy-MM-dd').format(DateTime.now()));
                    ...
                    Expanded(
                      child: GetX<TeacherGetxController>(
                          builder: (TeacherGetxController controller) {
                            _teacherGetxController.getParentChildren(DateFormat('yyyy-MM-dd').format(DateTime.now()));
                            print('${controller.childrenList.length}');
                            if (controller.childrenList.isNotEmpty) {
                              return GetX<TeacherGetxController>(
                                builder: (context) {
                ...
                ElevatedButton(
                  onPressed: () {
                    TeacherGetxController.to.setMAttendance(context,
                      resone: dropdownValue == 'غير محدد' ? _reasonController.text : dropdownValue);
                  },
                  child: Text(
                    'الاذن',
