...
Future<void> firebaseMessagingBackgroundHandler(
  ...
  print('Message: ${remoteMessage.messageId}Here');
}
...
mixin FbNotifications {
  ...
  //ANDROID
  static Future<void> initializeForegroundNotificationForAndroid()  async {
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      print('Message Received: ${message.messageId}Here');
